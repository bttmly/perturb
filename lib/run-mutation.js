...
var killed = emoji.get("skull") + "  ";
var alive = emoji.get("scream") + "  ";

function mutantReporter (mutant) {
  if (util.mutantIsAlive(mutant)) {
    console.log(alive, util.prettyDiff(mutant));
    return;
  }
  console.log(killed, mutant.name, "@" + mutant.loc, "\n");
}
