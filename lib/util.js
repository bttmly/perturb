...
function ChildProcessError (message, cmd, output, code) {
  Error.captureStackTrace(this, ChildProcessError);
...
ChildProcessError.prototype = Object.create(Error.prototype);
