...
function FormattedError () {
  var e = {message: util.format.apply(util, arguments)};
  Error.captureStackTrace(e, FormattedError);
  return e;
}
...
function ChildError (message, cmd, output, code) {
  Error.captureStackTrace(this, ChildError);
  this.message = util.print(message, cmd);
